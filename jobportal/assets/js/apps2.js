...
var handleSystemInformation = function() {
    var url = "assets/settings/voting-system.settings";
    var type = "POST";
    var data = "";
...
var App = function () {
	...
	return {
        ...
        handleLoadPage: function(hash) {
            ...
            var hash = hash.split(';');
            Pace.restart();
            var targetUrl = hash[0].replace('#cmd=','../templates/'+node+'/')+".html";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(hash.length>1){
                        targetUrl = hash[1].replace('content=','../templates/'+node+'/')+".html";
                        $.ajax({
                            type: 'POST',
                            url: targetUrl, //with the page number as a parameter
                            dataType: 'html',   //expect html to be returned
