        ...
        check_access:function(){
      	...
      	update_data:function(){
   		...
   		getByID:function(id){
			...
			var ajaxData = JSON.parse(ajax.responseText);
			// console.log(JSON.parse(ajaxData[0][0][5]));
			...
			var skills = JSON.parse(ajaxData[0][0][5]);
			if(applicationexpiry<now){
			...
			if(ajaxData[0][1].length > 0){
				$.each(ajaxData[0][1],function(i,v){
					...
					if(v[5] != ""){
						if(v[5] != "0"){
							var applicationstatus = skills;
							// console.log(JSON.parse(v[5]));
			...
			$('#job-post #txt_jobskills').html(skills);
					...
					$("a[data-cmd='info_applicant']").click(function(){
						...
						var	infodata = JSON.parse(data);
							...
							var content = ""+
											...
											"            <div>"+
											"                <h1 class='no-margins'>"+infodata[0][1][0][1]+", "+infodata[0][1][0][2]+" "+infodata[0][1][0][3]+"</h1>"+
											...
											"            <tr><td><strong>Gender: </strong>"+infodata[0][1][0][4]+"</td></tr>"+
											"            <tr><td><strong>Address: </strong>"+infodata[0][1][0][7]+"</td></tr>"+
											"            <tr><td><strong>Email Address: </strong>"+infodata[0][0][3]+"</td></tr>"+
											"            <tr><td><strong>Date of Birth: </strong>"+infodata[0][1][0][5]+"</td></tr>"+
											"            <tr><td><strong>Place of Birth: </strong>"+infodata[0][1][0][6]+"</td></tr>"+
											"            <tr><td><strong>Citizenship: </strong>"+infodata[0][1][0][8]+"</td></tr>"+
											"            <tr><td><strong>Height: </strong>"+infodata[0][1][0][9]+"</td></tr>"+
											"            <tr><td><strong>weight: </strong>"+infodata[0][1][0][10]+"</td></tr>"+
											"            <tr><td><strong>Mother: </strong>"+infodata[0][1][0][11]+"</td></tr>"+
											"            <tr><td><strong>Father: </strong>"+infodata[0][1][0][12]+"</td></tr>"+
											"            <tr><td><strong>Date Applied: </strong>"+infodata[0][1][0][14]+"</td></tr>"+
											"        </table>"+
											"		 <table class='table small m-b-xs'>"+
											"		<strong>ACADEMIC INFORMATION</strong>"+
											"            <tr><td><strong>Level: </strong></td></tr>"+
											"            <tr><td><strong>SchoolAttended: </strong></td></tr>"+
											"            <tr><td><strong>Degree: </strong></td></tr>"+
											"            <tr><td><strong>Period of Attendance: </strong></td></tr>"+
											"            <tr><td><strong>Highest Level: </strong></td></tr>"+
											"            <tr><td><strong>Year Graduated: </strong></td></tr>"+
											"        </table>"+
											"    </div>"+
											"</div>"+
										  "";
										  console.log(infodata[0][1][0][1]);
							$("#modal .modal-content").html(content);
							$('#modal').modal('open');	
						});
					});
