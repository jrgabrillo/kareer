...
if ( function( e, t ) {
				...
				for ( r in e )
					if ( s = e[ r ], null !== s )
						if ( s !== t ) {
							...
							n ? i.push( a ) : i.push( r + ":" + a )
						} else i.push( r + ":undefined" );
				else i.push( r + ":null" );
				return i
			},
			observer: function() {
		...
		var r = {
			...
			tabsize: 4,
			render: function( e, t ) {
				var n, r, a, s, i = new XSLTProcessor,
			...
			xmlFromString: function( e ) {
				var t, n;
				return e = e.replace( />\s{1,}</g, "><" ), null === e.trim()
					.match( /<\?xml/ ) && ( e = this.xml_decl + e ), this.is_ie ? ( n = new ActiveXObject( "Msxml2.DOMDocument" ), n.loadXML( e ), -1 === e.indexOf( "xsl:stylesheet" ) && n.setProperty( "SelectionLanguage", "XPath" ) ) : ( t = new DOMParser, n = t.parseFromString( e, "text/xml" ) ), n
			},
			extend: function( e, t ) {
...
String.prototype.fill || ( String.prototype.fill = function( e, t ) {
	...
	return -1 === this.indexOf( "translate(" ) && ( e = this.replace( /contains\(([^,]+),([^\\)]+)\)/g, function( e, t, n ) {
		var r = "abcdefghijklmnopqrstuvwxyz",
			a = n.trim()
			.slice( -1 );
		return "contains(translate(" + t + ", " + a + r.toUpperCase() + a + ", " + a + r + a + ")," + n.toLowerCase() + ")"
	} ) ), e.toString()
	...
	stringify: function( e ) {
		if ( e instanceof Object ) {
			...
			if ( e.toString !== Object.prototype.toString ) return '"' + e.toString()
				.replace( /"/g, "\\$&" ) + '"';
	...
	var n, r, a, s = {
		...
		hash_to_xml: function( e, t, n ) {
			var r, a, s, i, o, l, c, u, d, h = t.constructor === Array,
				m = this,
				p = [],
				f = [],
				g = function( t, r ) {
					if ( a = r[ t ], ( null === a || void 0 === a || "NaN" === a.toString() ) && ( a = null ), i = "@" === t.slice( 0, 1 ), o = n ? e : t, o == +o && r.constructor !== Object && ( o = "d:item" ), null === a ? ( l = null, c = !1 ) : ( l = a.constructor, c = l.toString()
							.match( m.rx_function )[ 1 ] ), i ) f.push( o.slice( 1 ) + '="' + m.escape_xml( a ) + '"' ), "String" !== c && f.push( "d:" + o.slice( 1 ) + '="' + c + '"' );
					else if ( null === a ) p.push( m.scalar_to_xml( o, a ) );
					else switch ( l ) {
						case Function:
							throw "JSON data should not contain functions. Please check jour structure.";
						case Object:
							p.push( m.hash_to_xml( o, a ) );
							break;
						case Array:
							if ( t === o ) {
								if ( s = a.constructor === Array )
									for ( u = a.length; u--; ) null !== a[ u ] && a[ u ] && a[ u ].constructor !== Array || ( s = !0 ), s || a[ u ].constructor !== Object || ( s = !0 );
								p.push( m.scalar_to_xml( o, a, s ) );
								break
							}
						case String:
			...
			if ( t.constructor === Array )
				for ( u = 0, d = t.length; d > u; u++ ) g( u.toString(), t );
			else
				for ( r in t ) g( r, t );
		...
		scalar_to_xml: function( e, t, n ) {
			var r, a, s, i = "";
			if ( null === e.match( this.rx_validate_name ) && ( i += ' d:name="' + e + '"', e = "d:name", n = !1 ), ( null === t || "NaN" === t.toString() ) && ( t = null ), null === t ) return "<" + e + ' d:constr="null"/>';
			...
			if ( 1 === t.length && t[ 0 ].constructor === Object ) {
				...
				var o = r.match( this.rx_node ),
					l = r.match( this.rx_constructor );
				return o = null !== o ? o[ 2 ].replace( this.rx_namespace, "" )
					.replace( />/, "" )
					.replace( /"\/$/, '"' ) : "", l = null !== l ? l[ 2 ] : "", r = r.match( this.rx_data ), r = null !== r ? r[ 2 ] : "", "<" + e + o + " " + l + ' d:type="ArrayItem">' + r + "</" + e + ">"
			}
			return 0 === t.length && t.constructor === Array ? "<" + e + ' d:constr="Array"/>' : n ? this.hash_to_xml( e, t, !0 ) : ( a = t.constructor, s = a.toString()
				.match( this.rx_function )[ 1 ], r = a === Array ? this.hash_to_xml( "d:item", t, !0 ) : this.escape_xml( t ), i += ' d:constr="' + s + '"', this.map.push( t ), i += ' d:mi="' + this.map.length + '"', "#text" === e ? this.escape_xml( t ) : "<" + e + i + ">" + r + "</" + e + ">" )
		},
	...
	for ( n && ( c = [ c ] ), a = c.length; a--; ) switch ( c[ a ].nodeType ) {
		...
		case 3:
			...
			break;
		default:
			r = +c[ a ].getAttribute( "d:mi" ), u.unshift( o[ r - 1 ] )
	}
	return "development" === Defiant.env && ( this.trace = JSON.mtrace( l, u, c ) ), u
} ), JSON.mtrace || ( JSON.mtrace = function( e, t, n ) {
	"use strict";
	for ( var r, a, s, i, o, l = window, c = JSON.stringify, u = c( e, null, "	" )
			.replace( /\t/g, "" ), d = [], h = 0, m = n.length, p = m ? n[ h ].ownerDocument.documentElement : !1, f = ( this.search.map, 0 ); m > h; h++ ) {
		switch ( n[ h ].nodeType ) {
			case 2:
				a = n[ h ].ownerElement ? n[ h ].ownerElement.getAttribute( "d:" + n[ h ].nodeName ) : "String", r = '"@' + n[ h ].nodeName + '": ' + l[ a ]( t[ h ] ), s = u.indexOf( r ), o = 0;
				break;
			case 3:
				a = n[ h ].parentNode.getAttribute( "d:constr" ), r = l[ a ]( t[ h ] ), r = '"' + n[ h ].parentNode.nodeName + '": ' + ( "Number" === r ? r : '"' + r + '"' ), s = u.indexOf( r ), o = 0;
				break;
			default:
				if ( n[ h ] === p ) continue;
				"String" === n[ h ].getAttribute( "d:constr" ) || "Number" === n[ h ].getAttribute( "d:constr" ) ? ( a = n[ h ].getAttribute( "d:constr" ), r = l[ a ]( t[ h ] ), s = u.indexOf( r, f ), r = '"' + n[ h ].nodeName + '": ' + ( "Number" === a ? r : '"' + r + '"' ), o = 0, f = s + 1 ) : ( r = c( t[ h ], null, "	" )
					.replace( /\t/g, "" ), s = u.indexOf( r ), o = r.match( /\n/g )
					.length )
		}
		i = u.substring( 0, s )
			.match( /\n/g )
	...
	if ( e.evaluate ) {
		for ( var n = e.createNSResolver( e.documentElement ), r = e.evaluate( t, e, n, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null ), a = [], s = 0, i = r.snapshotLength; i > s; s++ ) a.push( r.snapshotItem( s ) );
		return a
	}
	...
	for ( var i, o, l = n.trim()
			.replace( /(>)\s*(<)(\/*)/g, "$1\n$2$3" ), c = l.split( "\n" ), u = -1, d = 0, h = c.length; h > d; d++ )( 0 !== d || c[ d ].toLowerCase() !== s ) && ( i = null !== c[ d ].match( /<[A-Za-z_\:]+.*?>/g ), o = null !== c[ d ].match( /<\/[\w\:]+>/g ), null !== c[ d ].match( /<.*?\/>/g ) && ( i = o = !0 ), i && u++, c[ d ] = String()
		.fill( u, "	" ) + c[ d ], i && o && u--, !i && o && u-- );
	return c.join( "\n" )
		.replace( /\t/g, String()
			.fill( a, " " ) )
	...
	"use strict";
	var n = function( e ) {
			var t, r, a, s, i, o, l, c, u, d, h = {},
				m = window;
			switch ( e.nodeType ) {
				case 1:
					for ( i = e.getAttribute( "d:constr" ), "Array" === i ? h = [] : "String" === i && "" === e.textContent && ( h = "" ), t = e.attributes, c = 0, u = t.length; u > c; c++ ) d = t.item( c ), null === d.nodeName.match( /\:d|d\:/g ) && ( i = e.getAttribute( "d:" + d.nodeName ), o = i && "undefined" !== i ? "null" === d.nodeValue ? null : m[ i ]( "false" === d.nodeValue ? "" : d.nodeValue ) : d.nodeValue, h[ "@" + d.nodeName ] = o );
					break;
				case 3:
					r = e.parentNode.getAttribute( "d:type" ), o = r ? m[ r ]( "false" === e.nodeValue ? "" : e.nodeValue ) : e.nodeValue, h = o
			}
			if ( e.hasChildNodes() )
				for ( c = 0, u = e.childNodes.length; u > c; c++ )
					if ( a = e.childNodes.item( c ), s = a.nodeName, t = e.attributes, "d:name" === s && ( s = a.getAttribute( "d:name" ) ), "#text" === s ) i = e.getAttribute( "d:constr" ), "undefined" === i && ( i = void 0 ), l = a.textContent || a.text, o = "Boolean" === i && "false" === l ? "" : l, i || t.length ? i && 1 === u ? h = m[ i ]( o ) : e.hasChildNodes() && t.length < 3 ? h = i ? m[ i ]( o ) : o : h[ s ] = i ? m[ i ]( o ) : o : h = o;
					else {
						...
						switch ( i = a.getAttribute( "d:constr" ) ) {
							case "null":
								h.push ? h.push( null ) : h[ s ] = null;
								break;
							case "Array":
								a.parentNode.firstChild === a && "Array" === i && "d:item" !== s ? "d:item" === s || "Array" === i ? ( o = n( a ), h[ s ] = o.length ? [ o ] : o ) : h[ s ] = n( a ) : h.push ? h.push( n( a ) ) : h[ s ] = n( a );
								break;
							case "String":
							case "Number":
							case "Boolean":
								l = a.textContent || a.text, o = "Boolean" === i && "false" === l ? "" : l, h.push ? h.push( m[ i ]( o ) ) : h[ s ] = n( a );
								break;
							default:
