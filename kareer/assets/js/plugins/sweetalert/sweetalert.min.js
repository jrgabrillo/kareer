	...
	! function o( e, t, n ) {
		...
		1: [ function( o ) {
			...
			s = l = function() {
				...
				u.addClass( o, "show" ), o.querySelector( "p" )
					.innerHTML = e, t.querySelector( "input" )
					.focus()
		...
		3: [ function( t, n, o ) {
			...
			var a = t( "./utils" ),
				...
				l = function( e, t ) {
					var n = !0;
					r.hasClass( e, "show-input" ) && ( n = e.querySelector( "input" )
						.value, n || ( n = "" ) ), t.doneFunction( n ), t.closeOnConfirm && sweetAlert.close()
				},
				i = function( e, t ) {
					var n = String( t.doneFunction )
						.replace( /\s/g, "" ),
		...
		4: [ function( n, o, a ) {
			...
			var r = function( e, t ) {
				...
				m = function( e ) {
					...
					return t = "undefined" != typeof getComputedStyle ? parseInt( getComputedStyle( e )
						.getPropertyValue( "padding-top" ), 10 ) : parseInt( e.currentStyle.padding ), e.style.left = "", e.style.display = "none", "-" + parseInt( ( n + t ) / 2 ) + "px"
				},
				v = function( e, t ) {
		...
		8: [ function( e, t, o ) {
			...
			var a = e( "./utils" ),
				...
				i = function( e ) {
					...
					if ( o.innerHTML = e.html ? e.title : s.escapeHtml( e.title )
						.split( "\n" )
		...
		9: [ function( t, n, o ) {
			...
			var a = function( e, t ) {
				...
				i = function( e, t ) {
					e = String( e )
						.replace( /[^0-9a-f]/gi, "" ), e.length < 6 && ( e = e[ 0 ] + e[ 0 ] + e[ 1 ] + e[ 1 ] + e[ 2 ] + e[ 2 ] ), t = t || 0;
					var n, o, a = "#";
					for ( o = 0; 3 > o; o++ ) n = parseInt( e.substr( 2 * o, 2 ), 16 ), n = Math.round( Math.min( Math.max( 0, n + n * t ), 255 ) )
						.toString( 16 ), a += ( "00" + n )
						.substr( n.length );
					return a
				};
