...
ALTER TABLE `tbl_acadinfo`
  ADD CONSTRAINT `tbl_acadinfo_ibfk_1` FOREIGN KEY (`applicant_id`) REFERENCES `tbl_applicant` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_applicant`
--
ALTER TABLE `tbl_applicant`
  ADD CONSTRAINT `tbl_applicant_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tbl_personalinfo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tbl_businessmanagers`
  ADD CONSTRAINT `tbl_businessmanagers_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `tbl_business` (`business_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_career`
--
ALTER TABLE `tbl_career`
  ADD CONSTRAINT `tbl_career_ibfk_1` FOREIGN KEY (`applicant_id`) REFERENCES `tbl_applicant` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_skills`
--
ALTER TABLE `tbl_skills`
  ADD CONSTRAINT `tbl_skills_ibfk_1` FOREIGN KEY (`applicant_id`) REFERENCES `tbl_applicant` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
